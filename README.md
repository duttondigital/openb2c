...
Generated API and UI behavior can also derive from field-level presentation, validation, ordering, privacy, redaction, and relationship metadata. See [Field Metadata](./docs/field-metadata.md) and [Relationship Metadata](./docs/relationship-metadata.md).
