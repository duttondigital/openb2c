...
Generated API and UI behavior can also derive from field-level presentation, validation, ordering, privacy, redaction, relationship metadata, and role/policy metadata. See [Field Metadata](./docs/field-metadata.md), [Relationship Metadata](./docs/relationship-metadata.md), and [Role And Policy Metadata](./docs/policy-metadata.md).
