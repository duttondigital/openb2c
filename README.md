...
Generated API and UI behavior can also derive from field-level presentation, validation, ordering, privacy, and redaction metadata. See [Field Metadata](./docs/field-metadata.md).
