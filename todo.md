...
- [ ] Fix async registry key initialization race by awaiting key setup before serving requests.
...
- [ ] Add ontology support for indexes.
...
- [ ] Add validation metadata for min/max length, numeric ranges, regexes, enum values, and cross-field constraints.
...
- [ ] Add login and identity challenge flow.
...
- [ ] Choose first email provider and implement production OTP delivery.
